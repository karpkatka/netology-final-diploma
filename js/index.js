...
mainBlock.insertAdjacentHTML("beforeEnd",
    ...
    <div class="movie__info">
      ...
      <div class="movie__description">
        ...
        <p class="movie__data">
          <span class="movie__data-duration">${filmDuration}т</span>
...
// сохранить в локал инфу о выбранном сеансе: название, Зал, сеанс
// const seanceTime = Array.from(document.querySelectorAll(".movie-seances__time"));
...
//         let timeStampSeance = item.closest(".movie-seances__time-block").getAttribute("data-seance-time-stamp");
//         let hallIdSeance = item.closest(".movie-seances__hall").getAttribute("data-hall-id");
//         let chosenSeanceId = item.item.closest(".movie-seances__time-block").getAttribute("data-seance-id");
//         let filmTimeStamp = timeStampDay + (timeStampSeance * 60);

//         console.log(filmTimeStamp)
...
//текущий таймстэмп
//const timeStamp 
// для других дней прибавляем количество часов * количество минут * количество секунд, сохранить в дата=атрибуте data-time-stamp="45354534"
// ищем вкладку  с активным классом относительного него раскидываем значения сеансов
// сохранить в локал инфу и передать дальше
